...
import input_module_eiq_observables as input_module
...
'''
    ...
    Add your modular input logic to file input_module_eiq_observables.py
'''
class ModInputeiq_observables(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputeiq_observables, self).__init__("ta_eclecticiq", "eiq_observables", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputeiq_observables, self).get_scheme()
        scheme.title = ("Collect Observables")
        ...
        scheme.add_argument(smi.Argument("ip", title="IP",
                                         ...
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("uri", title="URL",
                                         description="Observable types to ingest",
                                         required_on_create=False,
                                         required_on_edit=False))
        scheme.add_argument(smi.Argument("filehash", title="FileHash",
                                         description="Observable types to ingest",
                                         required_on_create=False,
                                         required_on_edit=False))
    ...
    def get_checkbox_fields(self):
        checkbox_fields = []
        checkbox_fields.append("domain")
        checkbox_fields.append("ip")
...
if __name__ == "__main__":
    exitcode = ModInputeiq_observables().run(sys.argv)
